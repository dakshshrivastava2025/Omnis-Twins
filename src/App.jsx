...
export function App() {
  ...
  return (
    <div
      className="flex h-screen w-screen overflow-hidden text-gray-100 antialiased"
      style={{ backgroundColor: TOKENS.colors.bgApp, fontFamily: "ui-sans-serif, system-ui, sans-serif" }}
    >
      {/* Persistent Sidebar */}
